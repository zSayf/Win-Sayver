...
class WindowsSettingsLauncher(QSystemTrayIcon):
    ...
    def _setup_ui(self) -> None:
        ...
        try:
            ...
            self.setMinimumSize(1000, 700)  # Reduced minimum size for better responsiveness
    ...
    def _create_header_section(self) -> QWidget:
        ...
        # Remove fixed maximum height to make it responsive
        ...
        title_layout.setSpacing(2)  # Reduce spacing between title and subtitle

        title_label = QLabel("Win Sayver")  # type: ignore
        title_font = QFont()  # type: ignore
        title_font.setPointSize(16)  # Slightly smaller for better responsiveness
        ...
        self.collect_specs_btn.setMinimumHeight(32)  # Slightly smaller minimum height
        self.collect_specs_btn.setSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)  # type: ignore
        ...
        self.analyze_btn.setMinimumHeight(32)  # Slightly smaller minimum height
        self.analyze_btn.setSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)  # type: ignore
    ...
    def _create_content_section(self) -> QWidget:
        ...
        # Make tab widget responsive
        self.tab_widget.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)  # type: ignore
    ...
    def _create_analysis_setup_tab(self) -> QWidget:
        ...
        layout.setSizeConstraint(QLayout.SizeConstraint.SetMinimumSize)  # type: ignore
        ...
        self.error_description.setMinimumHeight(120)  # Reduced minimum height for better responsiveness
        self.error_description.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)  # type: ignore
        ...
        self.progress_bar.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)  # type: ignore
    ...
    def _create_system_info_tab(self) -> QWidget:
        ...
        # Make system info widget responsive
        self.responsive_system_info.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)  # type: ignore
    ...
    def _create_results_tab(self) -> QWidget:
        ...
        # Make results text responsive
        self.results_text.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)  # type: ignore
    ...
    def _create_settings_tab(self) -> QWidget:
        ...
        scroll_area.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)  # type: ignore
        scroll_area.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)  # type: ignore
        scroll_area.setFrameShape(QFrame.Shape.NoFrame)  # type: ignore
        
        # Create container widget for scroll area content
        content_widget = QWidget()  # type: ignore
        ...
        # Create main layout for tab and add scroll area
        main_layout = QVBoxLayout(tab_widget)  # type: ignore
